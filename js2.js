...
function WhoSpeaksEng(obj) {
  let englishEmployee = [];
  for (let i = 0; i < obj.length; i++) {
    for (let x = 0; x < obj[i].languages.length; x++)
      if (obj[i].languages[x] === "English") {
        englishEmployee.push(obj[i].firstName);
        break;
      }
  }
  return englishEmployee;
}
// console.log(WhoSpeaksEng(employees));



function projectGAMA(obj)
{

  return obj.filter(emp => emp.languages.includes("English")).map(emp => emp.firstName)
}
console.log(projectGAMA(employees))